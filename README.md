...
- **Пользователь:** регистрация (заявка на рассмотрение), после подтверждения админом — вход, каталог, поиск/фильтр, выдача и возврат книг, чтение PDF/TXT, обращения
- **Администратор:** подтверждение или отклонение регистраций, управление каталогом (CRUD книг), загрузка файлов, обработка обращений
...
Приложение откроется на http://localhost:5174 (или следующий свободный порт — см. вывод Vite). API — http://localhost:5050.
