...
import { CATALOG_GENRE_OPTIONS } from "./catalogGenreOptions.js";
...
function CatalogSearch() {
  ...
  const currentLabel = CATALOG_GENRE_OPTIONS.find((o) => o.value === genre)?.label ?? "Все жанры";
  ...
  return (
    <div className={styles.searchBar}>
      ...
      <div className={styles.searchBar__genreWrap} ref={genreRef}>
        ...
        {genreOpen && (
          <ul className={styles.searchBar__genreList} role="listbox" aria-label="Выберите жанр">
            {CATALOG_GENRE_OPTIONS.map((opt) => (
              <li
                key={opt.value}
                role="option"
      ...
      <button type="button" className={styles.searchBar__findBtn} onClick={handleFindClick}>
        Найти
      </button>
    </div>
  );
